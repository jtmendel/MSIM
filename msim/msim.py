...
if __name__ == "__main__":
    ...
    simulation_parameters = [Parameter("input_cube", "FITS input cube"),
                ...
                # Parameter("detector_systematics", "FITS input cube", default="False", choices = ["True", "False"]),  # currently removed. Maybe to include bias drift?
                Parameter("adr", "Simulate atmospheric differential refraction", default="False", choices = ["True", "False"]),
    ...
    if hasattr(args, "batch_mode") and args.batch_mode == True:
        ...
        class MSIM_GUI():
            def __init__(self, parent):
                ...
                create_field("zenith_seeing", panel_telescope.add_field("Zenith seeing [arcsec]", OptionMenu, default=seeing_choices[0], extra=seeing_choices))
